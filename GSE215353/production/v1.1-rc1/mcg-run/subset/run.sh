...
for gs_file in ${input_gs_dir}KC_75_traits_split.gs*; do
    ...
    qsub ${submission_script} \
        "/u/home/l/lixinzhe/project-geschwind/data/GSE215353/processed/v1.2/processed-75K-subset-mcg.h5ad" \
        "${gs_file}" \
        "mean_var_length" \
        "arcsine" \
        "inv_std" \
        '/u/home/l/lixinzhe/project-geschwind/port/scratch/revision/v1.1/ges215353_mcg_75K_subset/mean_var_length_with_cov/sampling/' \
        '/u/home/l/lixinzhe/project-geschwind/port/scratch/revision/v1.1/ges215353_mcg_75K_subset/mean_var_length_with_cov/' \
