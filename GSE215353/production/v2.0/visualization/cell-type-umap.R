...
# plot out the spatial region for the L5-ET neurons:
l5.et.exc <- rownames(meta)[meta$X_MajorType == 'L5-ET'];
l5.et.meta <- meta[l5.et.exc, ]

plot.df <- data.frame(
    UMAP_1 = l5.et.meta$UMAP_1,
    UMAP_2 = l5.et.meta$UMAP_2,
    tissue = as.factor(l5.et.meta$tissue),
    cell_type = as.factor(l5.et.meta$X_MajorType)
    );
rownames(plot.df) = rownames(l5.et.meta);
...
plot.path <- paste0("/u/home/l/lixinzhe/project-geschwind/plot/", date, '-GSE215353-l5-et-tissue-with-legend-umap.png')
png(
    filename = plot.path,
    width = 14,
    height = 14,
...
plot.path <- paste0("/u/home/l/lixinzhe/project-geschwind/plot/", date, '-GSE215353-l5-et-tissue-no-legend-umap.png')
png(
    filename = plot.path,
    width = 14,
    height = 14,
...
plot.path <- paste0("/u/home/l/lixinzhe/project-geschwind/plot/", date, '-GSE215353-l23-tissue-with-legend-umap.png')
png(
    filename = plot.path,
    width = 14,
    height = 14,
...
plot.path <- paste0("/u/home/l/lixinzhe/project-geschwind/plot/", date, '-GSE215353-l23-tissue-no-legend-umap.png')
png(
    filename = plot.path,
    width = 14,
    height = 14,
