### mean_var_length_run.sh ########################################################################
# regression of batch effect after mean and variance and gene length control gene matching
...
for gs_file in ${input_gs_dir}KC_75_traits_split.gs*; do
    ...
    qsub ${submission_script} \
        ...
        "mean_var_length" \
        "inv_std" \
        '/u/home/l/lixinzhe/project-geschwind/port/scratch/revision/v1.1/ges215353_75K_subset/mean_var_length_with_cov/sampling/' \
        '/u/home/l/lixinzhe/project-geschwind/port/scratch/revision/v1.1/ges215353_75K_subset/mean_var_length_with_cov/' \
        "/u/home/l/lixinzhe/project-geschwind/data/GSE215353/processed/production/processed-covarite-subset.cov"
