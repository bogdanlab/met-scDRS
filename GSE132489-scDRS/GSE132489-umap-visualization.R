...
mch.directory <- "/u/project/geschwind/lixinzhe/scDRS-output/GSE132489/mch/met-scDRS-v1-run/LXZ-74-traits/";
mcg.directory <- "/u/project/geschwind/lixinzhe/scDRS-output/GSE132489/mcg/met-scDRS-v1-run/LXZ-74-traits/";
p.cutoff <- 0.1;
...
write.table(
    meta,
    file = '/u/project/geschwind/lixinzhe/data/Liu_et_al_2021_methylation_gse132489/41586_2020_3182_MOESM9_ESM.csv',
    sep = '\t',
    quote = FALSE,
    col.names = TRUE,
    row.names = FALSE
