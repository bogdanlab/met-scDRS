...
for gs_file in ${input_gs_dir}KC_75_traits_split.gs*; do
    ...
    qsub ${submission_script} \
        ...
        "mean_var" \
        "inv_std" \
        '/u/home/l/lixinzhe/project-geschwind/port/scratch/revision/v1.1/ges132489_30K_subset/mean_var/sampling/' \
        '/u/home/l/lixinzhe/project-geschwind/port/scratch/revision/v1.1/ges132489_30K_subset/mean_var/'
