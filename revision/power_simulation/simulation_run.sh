...
###########################################################################################
# fixed overlap
output_dir="/u/home/l/lixinzhe/project-geschwind/port/scratch/revision/power_simulation/fixed-overlap/"
mch_h5ad_dir="/u/scratch/l/lixinzhe/revision_scratch/simulation/fixed-overlap/"
mkdir -p $output_dir
